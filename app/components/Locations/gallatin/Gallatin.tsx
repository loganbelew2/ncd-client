    ...
    <>
      <div className={styles.hero__container}>
        <div className={styles.header}>
          <h1 className={styles.title}>Professional Mobile Car Detailing in Gallatin, TN</h1>
          <p>
            We proudly serve all areas of Gallatin, TN, bringing premium car
      ...
      <section className={styles.gallatinSection}>
        <div className={styles.whyChooseUs}>
          ...
          <p>
            ...
            mobile car detailing services in Gallatin. Our services cover every
          ...
          <p>
            Whether you’re in the heart of Gallatin or surrounding areas, our
            team arrives ready to detail your vehicle on-site. Our service
            packages are tailored to your vehicle’s needs and budget, offering a
            hassle-free solution for those who want a clean and protected car
