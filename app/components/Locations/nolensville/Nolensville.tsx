  ...
  return (
    <section className={styles.nolensvilleSection}>
      ...
      <div className={styles.header}>
        <h1>Mobile Car Detailing in Nolensville</h1>
        <p>
          Nashville Car Detail delivers high-quality mobile car detailing
          services directly to your location in Nolensville. Whether it’s a
          ...
          all areas in Nolensville and its surrounding neighborhoods, we take
      ...
      <div className={styles.ctaSection}>
        <h2>Book Your Nolensville Detailing Today</h2>
        <p>
          Contact us to schedule your mobile car detailing service in Nolensville
