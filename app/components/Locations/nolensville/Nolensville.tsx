...
import styles from "./Nolensville.module.css";
import { useRouter } from "next/navigation";

export default function Nolensville() {
  ...
  return (
    <section className={styles.nolensvilleSection}>
      {/* Header Section */}
      <div className={styles.header}>
        <h1>Premium Mobile Car Detailing Services in Nolensville</h1>
        <p>
          Nashville Car Detail proudly offers high-quality mobile car detailing
          services directly to your location in Nolensville, TN. Our experienced
          ...
          We serve all neighborhoods in Nolensville, providing exceptional
      ...
      <div className={styles.ctaSection}>
        <h2>Book Your Nolensville Mobile Detailing Service Today</h2>
        <p>
          ...
          detailing service in Nolensville. Our team is ready to provide the
