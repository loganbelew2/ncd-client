    ...
    <section className={styles.franklinSection}>
      ...
      <div className={styles.header}>
        ...
        <p>
          ...
          services directly to your location in Franklin, TN. Our experienced
          ...
          We serve all neighborhoods in Franklin, providing exceptional customer
          service and a commitment to excellence. Whether you need a thorough
          wash, waxing, or interior shampooing, our services are designed to
          keep your car spotless and well-maintained in any season.
        </p>
      </div>

      {/* CTA Section */}
      <div className={styles.ctaSection}>
        <h2>Book Your Franklin Mobile Detailing Service Today</h2>
        <p>
          ...
          detailing service in Franklin. Our team is ready to provide the
