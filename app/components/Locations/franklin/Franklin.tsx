  ...
  return (
    <section className={styles.franklinSection}>
      ...
      <div className={styles.header}>
        <h1>Mobile Car Detailing in Franklin</h1>
        <p>
          Nashville Car Detail delivers high-quality mobile car detailing
          services directly to your location in Franklin. Whether it’s a
          ...
          all areas in Franklin and its surrounding neighborhoods, we take
      ...
      <div className={styles.ctaSection}>
        <h2>Book Your Franklin Detailing Today</h2>
        <p>
          Contact us to schedule your mobile car detailing service in Franklin
