    ...
    <section className={styles.smyrnaSection}>
      ...
      <div className={styles.header}>
        ...
        <p>
          ...
          services directly to your location in Smyrna, TN. Our experienced team
          specializes in comprehensive exterior and interior detailing, ensuring
          that your vehicle receives the meticulous care it deserves. We serve
          all neighborhoods in Smyrna, providing exceptional customer service
          and a commitment to excellence. Whether you need a thorough wash,
          waxing, or interior shampooing, our services are designed to keep your
          car spotless and well-maintained in any season.
        </p>
      </div>

      {/* CTA Section */}
      <div className={styles.ctaSection}>
        <h2>Book Your Smyrna Mobile Detailing Service Today</h2>
        <p>
          ...
          detailing service in Smyrna. Our team is ready to provide the highest
          standard of detailing, ensuring your vehicle looks its best.
        </p>
