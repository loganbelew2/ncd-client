  ...
  return (
    <section className={styles.smyrnaSection}>
      ...
      <div className={styles.header}>
        <h1>Mobile Car Detailing in Smyrna</h1>
        <p>
          Nashville Car Detail delivers high-quality mobile car detailing
          services directly to your location in Smyrna. Whether it’s a
          ...
          all areas in Smyrna and its surrounding neighborhoods, we take
      ...
      <div className={styles.ctaSection}>
        <h2>Book Your Smyrna Detailing Today</h2>
        <p>
          Contact us to schedule your mobile car detailing service in Smyrna
